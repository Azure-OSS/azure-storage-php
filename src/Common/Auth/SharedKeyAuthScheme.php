 ...
 */
final class SharedKeyAuthScheme implements AuthScheme
{
    ...
    public function signRequest(RequestInterface $request): RequestInterface
    {
        ...
        return $request->withHeader('Authorization', $signedKey);
    }
    ...
    private function computeSignature(
        ...
        foreach (self::INCLUDED_HEADERS as $header) {
            $stringToSign[] = array_change_key_case($headers)[strtolower($header)];
        }
